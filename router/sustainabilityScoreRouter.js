...
const {
  sustainabilityScoreMiddleware,
} = require("../MiddleWare/sustainabilityScoreMiddleware");
...
router.get("/sustainability/leaderboard", getSustainabilityLeaderboard);
